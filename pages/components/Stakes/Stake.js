...
const Stake = ({ stake }) => {
    ...
    return (
        <div className='text-center flex flex-2 flex-col my-2 rounded shadow-sm shadow-black bg-black duration-300 hover:-translate-y-2 justify-between'>
            ...
            <button onClick={() => handlestakeclick(stake?.id)}>
                {/* image of stake  */}
                ...
                {/* title and description of stake  */}
                <div className='p-4'>
            ...
            <button onClick={() => handlestakeclick(stake?.id)} className='mt-2 bg-blue-600 hover:bg-blue-700 hover:shadow-lg font-bold text-lg text-white py-2 px-6 rounded mb-0'>
                Stake
            </button>
